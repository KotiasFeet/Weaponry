...
execute as @e[type=item, nbt={OnGround:1b}, tag=!dropped_item, tag=!dropped_ammo_mult_item, nbt=!{Item:{id:"tacz:ammo"}}] run function weaponary:dropped_items_to_de/item_to_de
