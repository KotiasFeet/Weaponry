...
# SMG                                                                                                                                           SMG
execute as @e[type=item, tag=dropped_item, nbt={Item:{id:"tacz:ammo", tag:{AmmoId:"tacz:308"}}}] run data modify entity @s Item.Count set value 30
# Heavy                                                                                                                                        Heavy
execute as @e[type=item, tag=dropped_item, nbt={Item:{id:"tacz:ammo", tag:{AmmoId:"tacz:338"}}}] run data modify entity @s Item.Count set value 12
# Pistol                                                                                                                                      Pistol
execute as @e[type=item, tag=dropped_item, nbt={Item:{id:"tacz:ammo", tag:{AmmoId:"tacz:9mm"}}}] run data modify entity @s Item.Count set value 36
# Shotgun                                                                                                                                     Shotgun
...
# Energy                                                                                                                                            Energy
execute as @e[type=item, tag=dropped_item, nbt={Item:{id:"tacz:ammo", tag:{AmmoId:"emxarms:402x31"}}}] run data modify entity @s Item.Count set value 20
# Electrical                                                                                                                                                               Electrical
execute as @e[type=item, tag=dropped_item, nbt={Item:{id:"tacz:ammo", tag:{AmmoId:"immersive_armorer:high_power_capacitor"}}}] run data modify entity @s Item.Count set value 10
# Flammable Chemical                                                                                                                                        Flammable Chemical
execute as @e[type=item, tag=dropped_item, nbt={Item:{id:"tacz:ammo", tag:{AmmoId:"immersive_armorer:chemical"}}}] run data modify entity @s Item.Count set value 1
