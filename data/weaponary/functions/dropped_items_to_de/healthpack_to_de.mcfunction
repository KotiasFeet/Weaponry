execute at @s run summon interaction ~ ~.05 ~ {width:1.0f,height:0.3f,Tags:["withItem"], Passengers:[{id:"minecraft:item_display", item_display:"ground", view_range:0.07,  transformation:{left_rotation:[0f,.4f,0f,.9f],right_rotation:[0f,0f,0f,1f],scale:[1f,1f,1f],translation:[0f,.3f,0f]}}]}
